CREATE TABLE [prodcopy].[Emma__Emma_Group_Member__c]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Emma__Emm__copyl__0B91BA14] DEFAULT (getdate())
)
WITH
(
...
GO
CREATE CLUSTERED INDEX [CIX_Emma__Emma_Group_Member__c_Id] ON [prodcopy].[Emma__Emma_Group_Member__c] ([Id]) WITH (DATA_COMPRESSION = PAGE)
GO
