...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Contact__copyloa__4316F928] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [idx_contact_isdeleted] ON [prodcopy].[Contact] ([IsDeleted])
GO
