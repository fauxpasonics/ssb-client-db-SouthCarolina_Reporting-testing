...
[Total__c] [float] NULL,
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Transacti__copyl__3D2915A8] DEFAULT (getdate()),
[ContactID__c] [nvarchar] (18) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [prodcopy].[Transaction__c] ADD CONSTRAINT [pk_id_transaction] PRIMARY KEY CLUSTERED  ([Id])
GO
